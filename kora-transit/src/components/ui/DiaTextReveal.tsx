...
// Adapted from Magic UI "dia-text-reveal" — import switched to framer-motion,
// default band colors tuned to the KORA gold palette, text settles to ink.
...
const DEFAULT_COLORS = ["#E0C674", "#C9A84C", "#A8842F", "#E0C674", "#C9A84C"];
const BAND_HALF = 17;
