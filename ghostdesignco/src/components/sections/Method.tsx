  ...
  return (
    <section ref={ref} id="methode" data-station="method" aria-labelledby="method-title" className="relative h-[230vh]">
      <div className="sticky top-0 flex h-[100svh] items-end pb-[6svh] lg:items-center lg:pb-0">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(80%_60%_at_20%_78%,rgba(5,5,5,0.85),transparent_75%)] lg:bg-[radial-gradient(50%_70%_at_22%_50%,rgba(5,5,5,0.78),transparent_72%)]"
        />
