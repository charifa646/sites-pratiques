  ...
  return (
    <section ref={ref} id="realisations" data-station="work" aria-labelledby="work-title" className="relative h-[260vh]">
      <div className="sticky top-0 flex h-[100svh] items-end pb-[6svh] lg:items-center lg:pb-0">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(80%_55%_at_25%_80%,rgb(var(--c-void)/0.85),transparent_75%)] lg:bg-[radial-gradient(48%_70%_at_22%_52%,rgb(var(--c-void)/0.78),transparent_72%)]"
        />
